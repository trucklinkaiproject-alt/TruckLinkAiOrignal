...
class ShipperOrderPage extends StatefulWidget {
  const ShipperOrderPage({super.key});

  @override
  State<ShipperOrderPage> createState() => _ShipperOrderPageState();
}

class _ShipperOrderPageState extends State<ShipperOrderPage>
    with SingleTickerProviderStateMixin {
  late TabController _tabController;
  late OrderDetailCubit _orderDetailCubit;
  ...
  void initState() {
    ...
    _orderDetailCubit = OrderDetailCubit();
  ...
  void _fetchForCurrentTab() {
    _orderDetailCubit.fetchOrderDetails(
      context.read<UserCubit>().userId,
      status: _tabStatusFilters[_tabController.index],
    );
  }
